...
class TestFailsafe(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Initialize heartbeat time to avoid false timeout during tests
        self.failsafe.update_heartbeat()
    ...
    def test_check_link_timeout(self):
        ...
        self.failsafe._last_heartbeat_time = time.monotonic() - 100  # 100 seconds ago
    ...
    def test_check_link_normal(self):
        ...
        # Recent heartbeat
        self.failsafe._last_heartbeat_time = time.monotonic() - 1  # 1 second ago
        result = self.failsafe._check_link()
        self.assertIsNone(result)
