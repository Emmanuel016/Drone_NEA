...
class FlightConfig:
    ...
    MAX_ALTITUDE = 300  # meters (default ArduPilot limit)
...
class CameraConfig:
    ...
    ENABLE_PHOTO_DOWNLOAD = True  # Whether to automatically download photos
    PHOTO_DOWNLOAD_TIMEOUT = 30  # seconds
    PHOTO_FORMAT = "jpg"  # Default photo format
    ...
    # Simulation mode
    SIMULATION_MODE = True  # Set to True for simulation (saves placeholder files), False for hardware
